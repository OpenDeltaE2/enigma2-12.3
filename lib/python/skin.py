...
DEFAULT_SKIN = BoxInfo.getItem("HasFullHDSkinSupport") and "PLi-FullNightHD/skin.xml" or "AREADELTASAT-FHD/skin.xml"  # SD hardware is no longer supported by the default skin.
